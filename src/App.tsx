...
import AnalysisModule from "./pages/modules/AnalysisModule";
...
import AgentLoginPage from "./pages/AgentLoginPage"; // Import de la page agent
        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/login-agent" element={<AgentLoginPage />} /> {/* Route Agent */}
              ...
              <Route path="/dashboard/analysis" element={<AnalysisModule />} />
